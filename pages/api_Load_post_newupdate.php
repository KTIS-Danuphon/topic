...
foreach ($data_post_detail as $post) {
  ...
  switch ($post['fd_post_status']) {
    case 'todo':
      echo '<div class="dropdown"><span id="post_status"><span class="badge bg-light-danger rounded-pill f-12"><b style="font-size: medium;">ต้องทำ</b></span></span> <a class="avtar avtar-s btn-link-secondary dropdown-toggle arrow-none" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">';
      break;
    case 'doing':
      echo '<div class="dropdown"><span id="post_status"><span class="badge bg-light-primary rounded-pill f-12"><b style="font-size: medium;">ดำเนินการ</b></span></span> <a class="avtar avtar-s btn-link-secondary dropdown-toggle arrow-none" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">';
      break;
    case 'success':
      echo '<div class="dropdown"><span id="post_status"><span class="badge bg-light-success rounded-pill f-12"><b style="font-size: medium;">เสร็จสิน</b></span></span> <a class="avtar avtar-s btn-link-secondary dropdown-toggle arrow-none" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">';
      break;
  }
              ...
              <div class="card mb-2 shadow-sm">
                <div class="card-body py-2 px-3 d-flex align-items-center justify-content-between">
                  ...
                  <div class="text-muted d-flex align-items-center" style="font-size: 14px; margin-right:1%;cursor: pointer;">
                    <i class="ti ti-message-circle me-1" style="font-size: 18px;"></i> ' . select_count_conment($post_id, $object) . ' ความคิดเห็น
                  </div>
