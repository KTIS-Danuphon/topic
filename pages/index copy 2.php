      ...
      <div class="pc-content container">
              ...
              <div class="card-header">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1 mx-3">
                    ...
                    <button onclick="updatePostAndStatus()" class="btn btn-danger mt-2">
                      แก้โพสต์ 🫰
                    </button>
        ...
        <div class="row">
          ...
          <div id="post-container">
            ...
            <script>
              function updatePostAndStatus(post_id) {
              ...
              // 🔽 เนื้อหาใหม่ของคุณ
              const newStatusHtml = '<span class="badge bg-light-success rounded-pill f-12"><b>เสร็จสิ้น</b></span>';
...
`;
  ...
  <script>
    ...
    function reloadTagUserSelect_edit() { // ลบ tag-users แล้วสร้างใหม่
      ...
      // wrapperMain.appendChild(select); // ใส่ select เข้าไปใหม่
      ...
      select_tag_backup_edit.forEach(user => {
        ...
        if (data1.fd_post_tag.split(",").includes(String(user.inpost_user_id))) {
          ...
          const response = await fetch('action_edit_post.php', {
            ...
            .then(data => {
              ...
              if (data.success) {
                ...
                updatePostAndStatus(formData.get("post_user_id_edit"));
                // // ถ้ามีฟังก์ชันอัปเดตอื่น
                // if (cancelmodal_post("1")) { //สั่งปิด modal post ต้องreturn true
                //   loadNewPosts(); //โหลดโพสต์ใหม่
                // }
